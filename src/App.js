      ...
      <form onSubmit={(e) => {handleSubmit(e)}}>
        ...
        <div className="row">
          <div className="">
            ...
            { /*Quando o usuario entrar com o sexo a funcao, handleSexo() será chamada*/}
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-2">
            ...
            { /*Quando o usuario entrar com o CEP, a funcao, handleCEP() será chamada*/}
          </div>
          <div className="col-2">
            <label>Logradouro</label><br/>
            <input type="text" value={logradouro} placeholder="Logradouro" required onChange={(e) => {handleLogradouroChange(e)}} />
            { /*Quando o usuario entrar com o logradouro, a funcao, handleLogradouro() será chamada*/}
          </div>
        </div>
        <div className="row">
          <div className="col-2">
            ...
            { /*Quando o usuario entrar com o bairro, a funcao, handleBairro() será chamada*/}
          </div>
          <div className="col-2">
            <label> Complemento</label><br/>
            <input type="text" value={complemento} placeholder="Complemento" required onChange={(e) => {handleComplementoChange(e)}} />
            { /*Quando o usuario entrar com o complemento, a funcao, handleComplemento() será chamada*/}
          </div>
        </div>
        <div className="row">
          <div className="col-2">
            ...
            { /*Quando o usuario entrar com a cidade, a funcao, handleCidade() será chamada*/}
          </div>
          <div className="col-2">
            <div className="col-uf">
              ...
              { /*Quando o usuario entrar com o UF, a funcao, handleUf() será chamada*/}
            </div>
        </div>
